package com.infinitezerone.bgmplus.core.designsystem.theme
...
/** 深色遮罩上的评分文字 / 选中态圆点 */
val RatingGoldBright = Color(0xFFFFD54F)

/** 金色底上的前景文字（Rank 徽章等） */
val OnRatingGold = Color(0xFF3E1F00)

/** 想看 / 未选中标记橙 */
val WishOrange = Color(0xFFFF9800)

// 打卡动作色（1-Tap 快捷胶囊）

val ActionWish = Color(0xFF3FA9F5)
val ActionDoing = Color(0xFFFF406E)
val ActionCollect = Color(0xFF2ECC71)
